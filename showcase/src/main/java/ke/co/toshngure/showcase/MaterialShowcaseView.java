...
import ke.co.toshngure.showcase.shape.CircleShape;
import ke.co.toshngure.showcase.shape.NoShape;
import ke.co.toshngure.showcase.shape.RectangleShape;
import ke.co.toshngure.showcase.shape.Shape;
import ke.co.toshngure.showcase.target.Target;
import ke.co.toshngure.showcase.target.ViewTarget;
...
public class MaterialShowcaseView extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    public static int getSoftButtonsBarSizePort(Activity activity) {
        // getRealMetrics is only available init API 17 and +
    ...
    /**
     * BUILDER CLASS
     * Gives us a builder utility class init a fluent API for eaily configuring showcase views
     */
